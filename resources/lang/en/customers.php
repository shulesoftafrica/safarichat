...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Customer & Contacts Language Lines
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'upload' => [
        ...
        'sample_file_info' => 'Download our sample file to see the required format',
        ...
        'vcf_help' => 'How to export VCF from your phone?',
        'vcf_instructions' => 'Step-by-Step VCF Export Instructions',
        'vcf_step_1' => 'Open Contacts app on your phone',
        'vcf_step_2' => 'Go to Settings or Manage Contacts',
        'vcf_step_3' => 'Find Export option and choose "Export to VCF file"',
        'vcf_step_4' => 'Save VCF file to your phone storage',
        'vcf_step_5' => 'Transfer VCF file to your computer if needed',
        'vcf_step_6' => 'Click Browse and select the VCF file to upload',
        'vcf_note' => 'Note: VCF export steps may vary depending on your phone brand/model',
    ],
    ...
    'messages' => [
        ...
        'phone_format' => 'Enter phone number with country code (e.g. +255 712345678)',
        'lead_status_help' => 'Select the appropriate lead status based on the current conversation stage',
