...
1. on the page resources/service/ai-agents/index.blade.php , once user click Create New Sales Agent, if a package does not allow adding new agent, show that modal you create on footer to prompt user to upgrade
