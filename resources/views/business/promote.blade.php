        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div id="animationSandbox" class="">
                        <div class="shadow-sm p-4 d-inline-block rounded-circle">
                            <img src="../assets/images/logo-sm.png" alt="" class="center-block">
                        </div>                                                
                    </div>
                </div>
                        ...
                        <div class="col-sm-5 mx-auto">
                            <div class="input-group">
                                ...
                                <span class="input-group-append ml-2">
                                    <button class="btn btn-gradient-primary js--triggerAnimation" type="button">Animate Me !
                                    </button>
                                </span>
                            </div><!--end input group-->
                        </div><!--emd col-->
