            ...
            <div class="action-card">
                    ...
                    <div class="col-6">
                        ...
                        <h4 style="color: #1e293b; margin-bottom: 0;">
                            <?php if($total_budget > 0): ?>
                                Tsh <?php echo e(number_format($total_budget)); ?>
                    ...
                    <div class="col-6">
                        ...
                        <h4 style="color: #1e293b; margin-bottom: 0;">
                            <?php if($total_expenses > 0): ?>
                                Tsh <?php echo e(number_format($total_expenses)); ?>
                ...
                <div style="margin: 20px 0;">
                    <div style="background: #f1f5f9; border-radius: 10px; height: 8px; overflow: hidden;">
                        <div style="background: <?php echo e($usage_percent > 80 ? '#dc2626' : ($usage_percent > 60 ? '#f59e0b' : '#25d366')); ?>; 
                                    height: 100%; width: <?php echo e(min($usage_percent, 100)); ?>%; 
                                    border-radius: 10px; transition: width 0.3s ease;"></div>
                    </div>
                    <p style="color: #64748b; font-size: 0.85rem; margin-top: 8px; margin-bottom: 0;">
                        <?php echo e($usage_percent); ?>% of budget used • <?php echo e(100 - $usage_percent); ?>% remaining
                    </p>
                </div>
                
                <?php if($usage_percent < 50): ?>
                ...
                <div style="background: #f8fafc; color: #64748b; padding: 12px; border-radius: 8px; font-size: 0.9rem; margin: 20px 0;">
                    <i class="fas fa-info-circle"></i> No budget set. Focus on sending messages to your <?php echo e($guests); ?> contacts!
                </div>
                <?php endif; ?>
            </div>
        </div>
