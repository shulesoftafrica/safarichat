                    ...
                    <ul class="nav in mm-show">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= url('products') ?>">
                                <i class="fas fa-box align-middle mr-2" title="Products"></i><?php echo e(__('Products')); ?>

                            </a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link" href="<?= url('ai-agents') ?>">
                                <i class="fas fa-robot align-middle mr-2" title="AI Sales Officer"></i><?php echo e(__('AI Sales Officer')); ?>
