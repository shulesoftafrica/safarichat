...
<div class="registration-container">
    <div class="registration-card">
        <div id="wizard-app">
            ...
            <!-- Hidden form fields -->
            <form id="registration-form" method="POST" action="<?php echo e(url('api/registerBusiness')); ?>" style="display: none;">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safarichat\resources\views/auth/register.blade.php ENDPATH**/ ?>