        ...
        <div class="modal fade" id="payment_model" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel" aria-hidden="true">
            ...
            <div class="modal-content shadow-lg border-0 rounded-3">
                ...
                <div class="d-flex align-items-center w-100">
                    ...
                    <!-- <img src="<?php echo e(asset('images/payment-icon.svg')); ?>" alt="Payment" width="40" height="40"> -->
                    </div>
                    <div>
...
}?><?php /**PATH C:\xampp\htdocs\safarichat\resources\views/layouts/checkpayment.blade.php ENDPATH**/ ?>