        ...
        <div class="main-layout d-flex">
            ...
            <nav class="sidebar shadow-sm">
                <ul class="sidebar-nav nav flex-column py-3">
                    <li>
                        <a href="<?php echo e(url('service/index')); ?>" class="nav-link<?php echo e(request()->is('service/index') ? ' active' : ''); ?>">
                            <span>Products</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('service/jd')); ?>" class="nav-link<?php echo e(request()->is('service/jd') ? ' active' : ''); ?>">
            ...
            <div class="content-area flex-grow-1 p-3 ms-3">
                 <?php echo $__env->make('service.products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
function saveProduct() {
    ...
    fetch("<?php echo e(url('api/products')); ?>", {
        method: 'POST',
        body: formData,
        headers: {
...
function viewProduct(id) {
    ...
    fetch("<?php echo e(url('api/products')); ?>/" + id, {
        method: 'GET',
        headers: {
            'Accept': 'application/json',
...
function editProduct(id) {
    fetch("<?php echo e(url('api/products')); ?>/" + id + "/edit", {
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safarichat\resources\views/service/index.blade.php ENDPATH**/ ?>