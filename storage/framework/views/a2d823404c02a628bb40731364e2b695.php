                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <select id="instanceSelect" class="form-select">
                            ...
                            <?php $__currentLoopData = $whatsappInstances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($instance->instance_id); ?>"><?php echo e($instance->name ?? $instance->instance_id); ?></option>
...
$(document).ready(function() {
    ...
    $('#processMessages').click(function() {
        ...
        $.post(`<?php echo e(url('api/WaSender/process-messages/${currentInstanceId}')); ?>`)
    ...
    function loadMessages(page = 1) {
        ...
        $.get(`<?php echo e(url('/api/WaSender/incoming-messages/${currentInstanceId}')); ?>`, params)
            .done(function(response) {
                if (response.success) {
    ...
    function markAsProcessed(messageId) {
        $.post(`<?php echo e(url('/api/WaSender/mark-processed/${messageId}')); ?>`, {
            _token: $('meta[name="csrf-token"]').attr('content')
        })
        .done(function(response) {
            if (response.success) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safarichat\resources\views/whatsapp/incoming_messages.blade.php ENDPATH**/ ?>