...
<div class="modern-layout">
    ...
    <div class="sticky-login" id="login">
        <div class="login-logo">
            <img src="<?php echo e(asset(ROOT.'assets/images/safarichat.png')); ?>" alt="safarichat Logo">
        </div>
        ...
        <form method="POST" action="<?php echo e(url('setup/otp')); ?>" id="loginForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="legal-text">
                ...
                <a href="<?php echo e(url('/terms-and-conditions')); ?>" target="_blank">Terms and Conditions</a>.
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function applyTranslations(lang) {
            ...
            if (legalText) {
                legalText.innerHTML = `${t.termsAgreement} <a href="<?php echo e(url('/terms-and-conditions')); ?>" target="_blank">${t.termsConditions}</a>.<br><strong>${t.freeTrial}</strong> • No setup fees • Cancel anytime`;
            }
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safarichat\resources\views/auth/login.blade.php ENDPATH**/ ?>