    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card" style="--card-color: #25d366;">
                ...
                <div class="metric-value"><?php echo e(number_format($whatsapp_sent)); ?></div>
                <div class="metric-label">WhatsApp Messages Sent</div>
                <span class="metric-trend trend-up">
                    <i class="fas fa-arrow-up"></i> 
                    <?php if($messages_sent_week > 0): ?>
                        <?php echo e($messages_sent_week); ?> this week
                    <?php else: ?>
                        Total messages
                    <?php endif; ?>
                </span>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card" style="--card-color: #3b82f6;">
                ...
                <div class="metric-value"><?php echo e(number_format($whatsapp_received)); ?></div>
                <div class="metric-label">Customer Responses</div>
                <span class="metric-trend trend-up">
                    <i class="fas fa-arrow-up"></i> 
                    <?php echo e($response_rate); ?>% response rate
                </span>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card" style="--card-color: #8b5cf6;">
                ...
                <div class="metric-value"><?php echo e(number_format($active_conversations)); ?></div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card" style="--card-color: #f59e0b;">
                ...
                <div class="metric-value">
                    <?php if($whatsapp_sent > 0): ?>
                        <?php echo e(number_format(($successful_messages / max($whatsapp_sent, 1)) * 100, 1)); ?>%
                    <?php else: ?>
                        0%
                    <?php endif; ?>
                </div>
        ...
        <div class="col-lg-8">
            <div class="insights-card">
                ...
                <div class="insight-item">
                    ...
                    <div class="insight-content">
                        <div class="insight-text">
                            <?php if($active_conversations > 0): ?>
                                <?php echo e($active_conversations); ?> active customer conversations this month
                            <?php else: ?>
                        ...
                        <div class="insight-desc">
                            <?php if($response_rate > 50): ?>
                                Excellent response rate of <?php echo e($response_rate); ?>% shows customers love WhatsApp communication
                            <?php elseif($response_rate > 25): ?>
                                Good <?php echo e($response_rate); ?>% response rate - customers are engaging with your messages
                            <?php else: ?>
                ...
                <div class="insight-item">
                    ...
                    <div class="insight-content">
                        <div class="insight-text">
                            <?php if($messages_sent_today > 0): ?>
                                <?php echo e($messages_sent_today); ?> messages sent today
                            <?php else: ?>
                ...
                <div class="insight-item">
                    ...
                    <div class="insight-content">
                        <div class="insight-text">
                            Estimated messaging cost: TSh <?php echo e(number_format($total_messaging_cost)); ?>

                        </div>
                        <div class="insight-desc">
                            <?php if($roi_percentage > 100): ?>
                                Excellent ROI of <?php echo e($roi_percentage); ?>%! WhatsApp is generating strong returns
                            <?php elseif($roi_percentage > 0): ?>
                                Positive ROI of <?php echo e($roi_percentage); ?>% - your WhatsApp investment is paying off
                            <?php else: ?>
                ...
                <div class="insight-item">
                    ...
                    <div class="insight-content">
                        <div class="insight-text">
                            <?php echo e(number_format($total_contacts)); ?> total contacts ready for messaging
                        </div>
                        <div class="insight-desc">
                            <?php if($contacts_messaged > 0): ?>
                                You've reached <?php echo e(number_format($contacts_messaged)); ?> unique customers via WhatsApp
                            <?php else: ?>
        ...
        <div class="col-lg-4">
            <div class="comparison-card">
                ...
                <div class="comparison-item">
                    ...
                    <span class="comparison-value" style="color: #16a34a;"><?php echo e($response_rate); ?>% vs 2%</span>
                </div>
                ...
                <div class="comparison-item">
                    ...
                    <span class="comparison-value" style="color: #16a34a;"><?php echo e(number_format($customer_satisfaction, 1)); ?>/5 vs 2.8/5</span>
                </div>
                
                <?php if($roi_percentage > 0): ?>
                <div style="background: #dcfce7; color: #16a34a; padding: 12px; border-radius: 8px; margin-top: 16px; text-align: center;">
                    <strong>ROI: <?php echo e($roi_percentage); ?>%</strong><br>
            ...
            <div class="chart-card">
                ...
                <div class="performance-grid">
                    ...
                    <div class="performance-item">
                        ...
                        <div class="performance-value"><?php echo e($response_rate); ?>%</div>
                    ...
                    <div class="performance-item">
                        ...
                        <div class="performance-value"><?php echo e(number_format($auto_replies_sent)); ?></div>
                    ...
                    <div class="performance-item">
                        ...
                        <div class="performance-value"><?php echo e(number_format($contacts_messaged)); ?></div>
                        <div class="performance-label">Customers Reached</div>
                        <span class="performance-change trend-up">
                            <?php if($total_contacts > 0): ?>
                                <?php echo e(number_format(($contacts_messaged / $total_contacts) * 100, 1)); ?>% of total
                            <?php else: ?>
                                Ready to start
                            <?php endif; ?>
                        </span>
                ...
                <div class="engagement-metrics">
                    <div class="engagement-item">
                        <div class="engagement-value"><?php echo e(number_format($whatsapp_sent + $sms_sent)); ?></div>
                        <div class="engagement-label">Total Messages</div>
                    </div>
                    <div class="engagement-item">
                        <div class="engagement-value"><?php echo e(number_format($successful_messages)); ?></div>
                        <div class="engagement-label">Successfully Delivered</div>
                    </div>
                    <div class="engagement-item">
                        <div class="engagement-value"><?php echo e(number_format($whatsapp_received)); ?></div>
                        <div class="engagement-label">Customer Responses</div>
                    </div>
                    <div class="engagement-item">
                        <div class="engagement-value"><?php echo e(number_format($estimated_leads)); ?></div>
                        <div class="engagement-label">Estimated Leads</div>
                    </div>
                    <div class="engagement-item">
                        <div class="engagement-value"><?php echo e(number_format($connected_instances)); ?></div>
                        <div class="engagement-label">Active WhatsApp Instances</div>
                    </div>
                    <div class="engagement-item">
                        <div class="engagement-value"><?php echo e(number_format($text_messages)); ?></div>
                        <div class="engagement-label">Text Messages</div>
                    </div>
                    <div class="engagement-item">
                        <div class="engagement-value"><?php echo e(number_format($media_messages)); ?></div>
                        <div class="engagement-label">Media Messages</div>
                    </div>
                    <div class="engagement-item">
                        <div class="engagement-value">TSh <?php echo e(number_format($total_messaging_cost)); ?></div>
                                ...
                                series: [{
                                    ...
                                    data: [
                                        <?php if(!empty($reports)): ?>
                                            <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(isset($value->month_name)): ?>
                                                    ['<?php echo e(strtoupper($value->month_name)); ?>', <?php echo e($value->count); ?>],
                                                <?php else: ?>
                                                    ['<?php echo e($value->month); ?>/<?php echo e($value->year); ?>', <?php echo e($value->count); ?>],
                                                <?php endif; ?>
                                    ...
                                    data: [
                                        <?php if(!empty($reports)): ?>
                                            <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(isset($value->month_name)): ?>
                                                    ['<?php echo e(strtoupper($value->month_name)); ?>', <?php echo e(ceil($value->count * ($response_rate / 100))); ?>],
                                                <?php else: ?>
                                                    ['<?php echo e($value->month); ?>/<?php echo e($value->year); ?>', <?php echo e(ceil($value->count * ($response_rate / 100))); ?>],
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            ['No Data', 0]
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="background: #f8fafc; padding: 20px; border-radius: 12px; margin-bottom: 20px;">
                            ...
                            <?php if($whatsapp_sent == 0): ?>
                                <p>• Start sending WhatsApp messages to your <?php echo e(number_format($total_contacts)); ?> contacts</p>
                                <p>• Set up automated welcome messages for new customers</p>
                            <?php elseif($response_rate < 25): ?>
                                <p>• Improve message content to increase your <?php echo e($response_rate); ?>% response rate</p>
                                <p>• Send more personalized messages using customer names</p>
                            <?php else: ?>
                                <p>• Your <?php echo e($response_rate); ?>% response rate is excellent! Keep engaging</p>
                                <p>• Consider expanding to more customer segments</p>
                            <?php endif; ?>
                            
                            <?php if($auto_replies_sent == 0): ?>
                                <p>• Set up auto-replies to handle customer inquiries 24/7</p>
                            <?php endif; ?>
                            
                            <?php if($media_messages == 0): ?>
                    ...
                    <div class="col-md-6">
                        <div style="background: #f0f9ff; padding: 20px; border-radius: 12px; margin-bottom: 20px;">
                            ...
                            <?php if($roi_percentage > 100): ?>
                                <p>• Your excellent <?php echo e($roi_percentage); ?>% ROI shows WhatsApp is very profitable</p>
                                <p>• Consider increasing your messaging budget for more growth</p>
                            <?php elseif($roi_percentage > 0): ?>
                                <p>• Your <?php echo e($roi_percentage); ?>% ROI is positive - scale up messaging</p>
                            <?php else: ?>
                                <p>• Start measuring conversions to track your ROI</p>
                            <?php endif; ?>
                            
                            <?php if($active_conversations > 0): ?>
                                <p>• <?php echo e(number_format($active_conversations)); ?> customers are engaged - nurture these relationships</p>
                            <?php endif; ?>
...
function exportReport() {
    ...
    const reportData = {
        messages_sent: <?php echo e($whatsapp_sent); ?>,
        responses_received: <?php echo e($whatsapp_received); ?>,
        response_rate: <?php echo e($response_rate); ?>,
        active_conversations: <?php echo e($active_conversations); ?>,
        total_cost: <?php echo e($total_messaging_cost); ?>,
        estimated_revenue: <?php echo e($estimated_total_revenue); ?>,
        roi_percentage: <?php echo e($roi_percentage); ?>,
        success_score: <?php echo e($success_score ?? 0); ?>
    ...
    <?php if($whatsapp_sent == 0): ?>
        setTimeout(() => {
            if(confirm('Welcome to SafariChat WhatsApp Business Analytics!\n\nWould you like to start sending your first messages to engage customers?')) {
                window.location.href = "<?php echo e(url('/guest')); ?>";
            }
        }, 2000);
    <?php endif; ?>
});
...
<?php if($response_rate > 50 && $whatsapp_sent > 100): ?>
    setTimeout(() => {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safarichat\resources\views/message/report.blade.php ENDPATH**/ ?>