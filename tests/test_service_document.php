<?php
/**
 * Test WaSenderService sendDocument method
 */
...
echo "=== Testing WaSenderService::sendDocument() ===\n\n";

try {
    $service = new WaSenderService();
    
    $phoneNumber = '+255714825469';
    $documentPath = 'storage/uploads/card.pdf';
    $filename = 'card.pdf';
    $caption = 'Here is your requested document - Quarterly Report';
    
    echo "📱 Recipient: $phoneNumber\n";
    echo "📄 Document: $documentPath\n";
