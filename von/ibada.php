...
class Ibada extends Database {
    ...
    public function reminders() {
        ...
        $query = 'SELECT a.name,a.phone from users a join user_events b on a.id=b.user_id join events c on c.id=b.event_id where c.date=current_date-7';
